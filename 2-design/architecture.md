...
- `ASM-fufire-api-available` (High, Verified by snapshot 2026-05-08) — live `/v1/fusion` response shape verification deferred to Phase 3 (`TASK-configure-fufire-live`).
