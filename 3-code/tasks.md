...
| TASK-reapprove-fufire-artefacts | Re-approve `CON-fufire-chart-endpoint` (Draft) and `REQ-F-fufire-chart-mapping` (Draft) via `/SDLC-elicit` after `STK-founder` reviews the new `/v1/fusion` text | P2 | Todo | [REQ-F-fufire-chart-mapping](../1-spec/requirements/REQ-F-fufire-chart-mapping.md) | TASK-decide-fufire-deployment | 2026-05-08 | Both artefacts downgraded 2026-05-08 per `DEC-fufire-baseline`. Re-approval restores Approved counts in `CLAUDE.md`. |
