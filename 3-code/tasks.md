...
| TASK-refresh-spec-design-assessments | Re-run gap analysis (Spec) + completeness assessment (Design) to refresh stale numbers in `CLAUDE.md` after the 2026-05-08 ASM-Verified + CON-Draft + REQ-Draft transitions | P3 | Todo | - | TASK-reapprove-fufire-artefacts | 2026-05-08 | Self-flagged stale via `(stale — ...)` markers in `CLAUDE.md` lines 55 + 63. Best run after re-approval to avoid double-refresh churn. |
